...
import { Users, Home, FileText, AlertTriangle, Calendar, Clock, User } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Here's what's happening in your care homes today.</p>
      </div>
